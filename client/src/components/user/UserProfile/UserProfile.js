    ...
    <Container component="main" maxWidth="xs">
      ...
      <div className={classes.paper}>
        ...
        <form className={classes.form} noValidate>
          ...
          />
          {!!nameField.error && (
            <Alert severity="error">{nameField.error}</Alert>
          )}
          <TextField
            variant="outlined"
            margin="normal"
          ...
          />
          {!!emailField.error && (
            <Alert severity="error">{emailField.error}</Alert>
          )}
          <TextField
            variant="outlined"
            margin="normal"
          ...
          {!!currentPasswordField.error && (
            <Alert severity="error">{currentPasswordField.error}</Alert>
          )}
          <TextField
            variant="outlined"
            margin="normal"
          ...
          {!!newPasswordField.error && (
            <Alert severity="error">{newPasswordField.error}</Alert>
          )}
          <TextField
            variant="outlined"
            margin="normal"
          ...
          />
          {!!retypePasswordField.error && (
            <Alert severity="error">{retypePasswordField.error}</Alert>
          )}
